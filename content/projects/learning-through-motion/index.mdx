...
summary: A five-week refresh of an education platform — new messaging, new art
  direction, and a fast Next.js build shipped on a real deadline.
date: 2024-09-01
tags:
  - design
  - web
...
cover: https://dg7fq1nf3c2ygasz.public.blob.vercel-storage.com/projects/learning-through-motion.png
coverAlt: Learning Through Motion homepage — "Growing Towards Independence" with
  programme booking calls to action
draft: false
---
